...
export interface FeedFilters {
  ...
  sourceFamily: string
  sourceId: string
  activity: "to_review" | "all" | "any_activity" | "applied" | "dismissed" | "snoozed" | "has_feedback"
  feedback: "" | "good_match" | "bad_match" | "eligibility_wrong" | "irrelevant_role" | "duplicate_issue"
}
    ...
    >
      ...
      <div className="flex flex-col gap-1">
        ...
        <select
          ...
          onChange={(e) => onChange({ ...filters, activity: e.target.value as FeedFilters["activity"] })}
        >
      ...
      <div className="flex flex-col gap-1">
        ...
        <select
          ...
          onChange={(e) => onChange({ ...filters, feedback: e.target.value as FeedFilters["feedback"] })}
        >
