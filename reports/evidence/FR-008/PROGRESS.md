...
**Checkpoint:** W0.2/W1.1–W1.4 reviewable backend foundation; W2.1 integrated locally, one queue recovery fixture remains
...
**Remaining:** Remove the remaining immediate-recovery lease boundary from the PostgreSQL queue test, then run a fresh integrated suite once. W2.2 onward, feed controls, tracking workflows, Founder UX, performance/E2E proof, gold-set review, and terminal acceptance remain.

**Next:** Complete `W1-QUEUE-LEASE-RECOVERY-REMEDIATION`, then run integrated Wave 1 R8 before pushing W2.1.
